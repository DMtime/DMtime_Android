...
import com.jaemin.gallery.databinding.PostItemBinding
...
class PostsViewHolder(private val binding: PostItemBinding, private val galleryPresenter: GalleryPresenter) : RecyclerView.ViewHolder(binding.root){
